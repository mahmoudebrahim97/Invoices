    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/user.jpg') }}"><span
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"
                style="font-weight: bold;font-size:17px; color:#5B596D;text-align:center;">فواتير</li>
            <li class="slide">
            ...
            @can('الفواتير')
                <li class="side-item side-item-category" style="font-size: 15px;">الفواتير</li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('paid_invoices') }}">الفواتير المدفوعه </a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('unpaid_invoices') }}">الفواتير الغير مدفوعه</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('spaid_invoices') }}">الفواتير المدفوعه جزئيآ</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('invoice.softDeleted') }}">الفواتير المؤرشفة</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices_reports') }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customers') }}">تقارير العملاء</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('index/sections') }}">الاقسام</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ route('products') }}">اضافة منتج</a></li>
                        @endcan
                        <li></li>
                    </ul>
                </li>
